...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/23 13:33:31 by roglopes          #+#    #+#             */
/*   Updated: 2023/09/05 21:06:01 by roglopes         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Checks if the int 'argument' is a alphanumeric character
 * from the ASCII table.
 * 
 * @param argument a int
 * @return Int '1' for true or int '0' for false.
*/
int		ft_isalnum(int argument);

/**
 * @brief Checks if the int 'argument' is in the ASCII table.
 * 
 * @param argument a int
 * @return Int '1' for true or int '0' for false.
*/
...
/**
 * @brief Checks if the int 'argument' is a printable character
 ...
 * 
 * @param argument a int
 * @return The converted letter, or 'argument' if the conversion 
 * was not possible.
*/
 ...
 * 
 * @param dest destination string to received the copy of 'src'
 ...
 * @param dest destination string to received the copy of 'src'
 * @param src source string to be copy
 * @param size the full size of the 'dest' buffer
 * @return The total length of the string they tried to create.
*/
